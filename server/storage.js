...
var PostgresStorage = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        console.error("Error in getUser:", error_1);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_2 = _a.sent();
                        console.error("Error in getUserByUsername:", error_2);
                        return [2 /*return*/, undefined];
                    case 3: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_3 = _a.sent();
                        console.error("Error in createUser:", error_3);
                        throw error_3;
                    case 3: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_4 = _a.sent();
                        console.error("Error in createDataEntry:", error_4);
                        throw error_4;
                    case 3: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, pool.query('SELECT * FROM data_entries ORDER BY created_at DESC')];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result.rows.map(this.mapDataEntryFromDb)];
                    case 2:
                        error_5 = _a.sent();
                        console.error("Error in getDataEntries:", error_5);
                        return [2 /*return*/, []];
                    case 3: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, pool.query('SELECT * FROM data_entries WHERE date >= $1 AND date <= $2 ORDER BY created_at DESC', [startDate, endDate])];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result.rows.map(this.mapDataEntryFromDb)];
                    case 2:
                        error_7 = _a.sent();
                        console.error("Error in getDataEntriesByDateRange:", error_7);
                        return [2 /*return*/, []];
                    case 3: return [2 /*return*/];
                }
            });
    ...
    PostgresStorage.prototype.updateDataEntry = function (id, updateData) {
        return __awaiter(this, void 0, void 0, function () {
            var updates, values, paramIndex, result, error_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 4:
                        error_8 = _a.sent();
                        console.error("Error in updateDataEntry:", error_8);
                        return [2 /*return*/, undefined];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_9 = _a.sent();
                        console.error("Error in deleteDataEntry:", error_9);
    ...
    // Helper method to map database row to DataEntry type
