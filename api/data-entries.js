...
export default function handler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var query, _a, startDate, endDate, entries_1, entries, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    query = entryQuerySchema.safeParse(req.query);
                    if (!query.success) {
